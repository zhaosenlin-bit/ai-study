...
字段约定以 docs/api/openapi-contract-v0.yaml 的 KnowledgePoint / Question 为准，
...
class SubjectMathData:
    ...
    :param knowledge_dir: 知识图谱目录（默认仓库 data/knowledge_graph/math）
    :param question_dir: 题库目录（默认仓库 data/question_bank/math）
    """
