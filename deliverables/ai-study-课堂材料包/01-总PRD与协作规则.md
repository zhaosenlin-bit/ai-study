...
docs/api/                         # 接口契约
docs/roles/                       # 五人执行文档
docs/proposals/                   # 学生创意方案和老师最终决策
docs/03-document-reading-and-versioning-guide.md
docs/CHANGELOG.md                 # 文档版本记录
...
每个创意方案必须按 `docs/proposals/student-proposal-template.md` 写成 1 页以内，建议保存到：
...
老师课后整合时，把每个创意标记为 `采纳`、`延期`、`暂不做`。被采纳的创意必须写清楚它归哪个角色负责、改哪个接口或页面、怎么验收。最终决策写入 `docs/proposals/final-decision.md`，再同步更新本文档和 A-E 角色文档。
...
1. 新建或更新 `docs/proposals/final-decision.md`，记录老师最终选择。
2. 更新本文档，把采纳的创意写进 PRD、架构和验收标准。
3. 更新 `docs/roles/00-role-assignment-board.md` 和 A-E 角色文档。
4. 如果接口字段变了，先改 `docs/api/openapi-contract-v0.yaml`。
5. 更新 `docs/01-classroom-student-handbook.md`，保持课堂讲解口径一致。
6. 重新生成 Word 投屏讲义。
7. 更新 `docs/CHANGELOG.md`，写清楚版本变化。
