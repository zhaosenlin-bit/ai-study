...
from app import db
from app.routers import agent, auth, diagnosis, me, reports, review, students
...
for router in (diagnosis.router, students.router, agent.router, review.router, reports.router, auth.router, me.router):
