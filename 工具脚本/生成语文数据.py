...
生成内容:
- 数据/knowledge_graph/chinese/chinese_g3..6.json:24 个知识点(3-6 年级)
- 数据/question_bank/chinese/chinese_q_g3_*.json:30 题(古诗/阅读/识字/表达)

用法: python 工具脚本/gen_chinese_data.py
"""
