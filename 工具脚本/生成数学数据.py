...
生成内容:
- 数据/knowledge_graph/math/math_g3..6.json:32 个知识点(3-6 年级,含前置依赖)
- 数据/question_bank/math/math_q_g3_*.json:42 诊断题 + 20 巩固题(_p) + 10 复习题(_r)
满足 测试/subject_math/test_subject_math.py 全部断言。

用法: python 工具脚本/gen_math_data.py
"""
