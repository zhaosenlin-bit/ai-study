...
> 端口固定为 **5174**（本机 5173 被其他项目占用），与 `测试/e2e/playwright.config.ts` 保持一致。
...
- 所有接口按 `文档/api/openapi-contract-v0.yaml` 调用，共享类型在 `包/contracts/src/types.ts`。
